...
class TestMotorControl(Node):
    ...
    def cmd_rpm(self, msg):
        ...
        # self.desiredRPM_FR = self.desiredRPM_FL
        ...
        self.desiredRPM_RR = self.desiredRPM_FL
    ...
    def FL_control(self, fl_spd_err):
        ...
        print(f'real spd FL: {realspd}')
        realspd = max(min(realspd, 61),0)
    ...
    def FR_control(self, fr_spd_err):
        ...
        print(f'real spd FR: {realspd}')
        realspd = max(min(realspd, 61),0) + 128
        packet = bytearray([realspd])
        self.ss.write(packet)
    ...
    def RL_control(self, rl_spd_err):
        ...
        print(f'real spd RL: {realspd}')
        realspd = max(min(realspd, 61),0) 
        packetRL = bytearray([realspd])
    ...
    def RR_control(self, rr_spd_err):
        ...
        print(f'real spd RR: {realspd}')
        realspd = max(min(realspd, 61),0) + 128
        packetRR = bytearray([realspd])
